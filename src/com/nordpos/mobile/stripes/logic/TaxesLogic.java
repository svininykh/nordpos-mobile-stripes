...
package com.nordpos.mobile.stripes.logic;

import com.nordpos.mobile.stripes.model.Tax;
...
public class TaxesLogic {
    ...
    public TaxesLogic(List<Tax> taxList) {
        ...
        Collections.sort(taxListOrdered, new Comparator<Tax>() {
            ...
            public int compare(Tax o1, Tax o2) {
                if (o1.getApplicationRateOrder() < o2.getApplicationRateOrder()) {
                    return -1;
    ...
    public Double getTaxRate(String taxCategoryId, Date date) {
    ...
    public Tax getTax(String taxCategoryId, Date date) {
        ...
        for (Tax tax : taxList) {
            if (tax.getParentId() == null && tax.getCategory().equals(taxCategoryId) && tax.getValidFrom().compareTo(date) <= 0) {
